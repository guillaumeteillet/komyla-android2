...
public class UserCreateSSOFb extends AsyncTask<Void, Void, HttpResponse> {
    private final String        _tokenCSRF;
    private final Context       _context;
    private List<Cookie>        _cookies;
    private String              mfbTokenAccess;
    ...
    public UserCreateSSOFb(String _tokenCSRF, Context _context, String fbTokenAccess) {
        this._tokenCSRF = _tokenCSRF;
        this._context = _context;
        mfbTokenAccess = fbTokenAccess;
    }



    private HttpResponse createSSOFbUser() throws Exception {

        String url = _context.getResources().getString(R.string.url_api_final_v1)
                + _context.getResources().getString(R.string.url_api_user_session_ssofb);
        ...
        dataToSend.put("access_token", mfbTokenAccess);

...
public class GetTransactionFromAPI extends AsyncTask<Void, Void, HttpResponse> {
    ...
    public GetTransactionFromAPI(String _tokenCSRF, Context _context, String code) {
    ...
    private HttpResponse getTransaction() throws Exception {

        String url = _context.getResources().getString(R.string.url_api_final_v1)
                + _context.getResources().getString(R.string.url_api_user_get_transaction_from_cashregister);

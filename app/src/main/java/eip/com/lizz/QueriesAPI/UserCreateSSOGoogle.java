...
public class UserCreateSSOGoogle extends AsyncTask<Void, Void, HttpResponse> {
    ...
    private String              mgoogleTokenAccess;
    ...
    public UserCreateSSOGoogle(String _tokenCSRF, Context _context, String googleTokenAccess, String googleRefreshToken) {
        this._tokenCSRF = _tokenCSRF;
        this._context = _context;
        mgoogleTokenAccess = googleTokenAccess;
        mgoogleRefreshToken = googleRefreshToken;
    }



    private HttpResponse createSSOGoogleUser() throws Exception {
        ...
        dataToSend.put("access_token", mgoogleTokenAccess);
        dataToSend.put("refresh_token", mgoogleRefreshToken);
